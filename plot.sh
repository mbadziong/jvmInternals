...
echo 'plot "jvmTests.dat" u 1:2 w lp t "by reference primitive", "jvmTests.dat" u 1:3 w lp t "by reflection int", "jvmTests.dat" u 1:4 w lp t "by reference object", "jvmTests.dat" u 1:5 w lp t "by reflection object"' >> conf.plot
gnuplot conf.plot
